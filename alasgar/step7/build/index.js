...
var ASM_CONSTS = {
 ...
 281479: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 281562: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 281631: () => { return window.innerWidth; },  
 281661: () => { return window.innerHeight; }
};
