...
var ASM_CONSTS = {
 ...
 283543: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 283626: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 283695: () => { return window.innerWidth; },  
 283725: () => { return window.innerHeight; }
};
