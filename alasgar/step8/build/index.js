...
var ASM_CONSTS = {
 ...
 281415: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 281498: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 281567: () => { return window.innerWidth; },  
 281597: () => { return window.innerHeight; }
};
